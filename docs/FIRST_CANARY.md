...
pnpm canary:first --publish --confirm @vllnt/convex-buckets
```
...
Install explicitly with `pnpm add @vllnt/convex-buckets@canary`.
...
```sh
npm view @vllnt/convex-buckets dist-tags --registry=https://registry.npmjs.org --@vllnt:registry=https://registry.npmjs.org
npm view @vllnt/convex-buckets@0.1.0-canary.0 dist.integrity --registry=https://registry.npmjs.org --@vllnt:registry=https://registry.npmjs.org
```
